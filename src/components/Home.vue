<template>
  <div>
    <h1 class="display-1 font-weight-regular mb-4">Negocie e consulte suas Ações</h1>
    <v-sheet
      :elevation="6"
      class="pa-2 primary"
    >
      <v-icon class="white--text font-weight-light">info</v-icon>
    ...
    <v-sheet
      :elevation="6"
      class="pa-2 green lighten-1 mt-3 "
    >
      <v-icon class="white--text font-weight-light">info</v-icon>
      <span class="headline white--text font-weight-light">
